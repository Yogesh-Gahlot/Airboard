...
button_x1, button_y1, button_x2, button_y2 = 50, 50, 150, 100
button_a1, button_b1, button_a2, button_b2 = 450, 50, 550, 100

def generate_frames(cam_index=0):
    global video, canvas, prev_x, prev_y, color_code, eraser_mode, color

    if video is None or not video.isOpened():
        video = cv.VideoCapture(int(cam_index))
...
def video_feed():
    cam_index = request.args.get("cam_index", 0, type=int)
