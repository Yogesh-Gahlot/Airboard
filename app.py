...
def generate_frames():
    ...
    with mp_hands.Hands(min_detection_confidence=0.5, min_tracking_confidence=0.5) as hands:
        while True:
            ...
            # Draw buttons
            cv.rectangle(image, (button_a1, button_b1), (button_a2, button_b2), (255, 0, 0) if color_code else (0, 0, 255), -1 if color_code else 2)
            cv.putText(image, "RED", (button_a1, button_b1 + 35), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 1)

            cv.rectangle(image, (button_x1, button_y1), (button_x2, button_y2), (0, 0, 255), -1 if eraser_mode else 2)
